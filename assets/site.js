  ...
  var KB = isES
    ? {
        fares:
          ...
          ".",
        airport:
          "Cubrimos LAX, John Wayne (SNA), Burbank (BUR) y Long Beach (LGB), más terminales privadas. Tu chofer te recibe con un cartel con tu nombre, monitoreamos tu vuelo en tiempo real y la espera es de cortesía en recogidas de aeropuerto. Viajas en una Chevrolet Suburban 2026 (hasta 6 pasajeros + equipaje).",
    ...
    : {
        fares:
          ...
          ".",
        airport:
          "We cover LAX, John Wayne (SNA), Burbank (BUR) and Long Beach (LGB), plus private terminals. Your chauffeur meets you with a name sign, we track your flight in real time, and wait time is complimentary on airport pickups. You ride in a 2026 Chevrolet Suburban (up to 6 passengers + luggage).",
