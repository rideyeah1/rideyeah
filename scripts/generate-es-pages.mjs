...
const PAGES = [
  ...
  },
  {
    ...
    map: [
      ...
      ["RideYeah operates a fleet of 20+ premium full-size luxury SUVs — Cadillac Escalade, Chevrolet Suburban and more — with spacious executive comfort, premium leather, onboard Wi-Fi and professional chauffeurs across Los Angeles & Orange County.",
       "RideYeah opera una flota de más de 20 SUV de lujo premium de tamaño completo — Cadillac Escalade, Chevrolet Suburban y más — con amplio confort ejecutivo, piel premium, Wi-Fi a bordo y choferes profesionales en Los Ángeles y Orange County."],
      ["luxury SUV chauffeur service Los Angeles, executive SUV service, Cadillac Escalade chauffeur, Chevrolet Suburban service, private SUV service LAX",
       "servicio de chofer en SUV de lujo Los Ángeles, servicio SUV ejecutivo, chofer Cadillac Escalade, servicio Chevrolet Suburban, servicio SUV privado LAX"],
      ...
      ["We run a fleet of 20+ premium full-size SUVs — from the Cadillac Escalade to the Chevrolet Suburban — held to one standard of space, comfort and discretion, every time, across Los Angeles &amp; Orange County.",
       "Operamos una flota de más de 20 SUV premium de tamaño completo — desde la Cadillac Escalade hasta la Chevrolet Suburban — con un mismo estándar de espacio, confort y discreción, siempre, en Los Ángeles y Orange County."],
      /* why RideYeah */
      [">Why RideYeah</span>", ">Por qué RideYeah</span>"],
