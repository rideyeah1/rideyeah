...
const SHARED = [
  ...
  [">Accessibility</a>", ">Accesibilidad</a>"],
...
const PAGES = [
  {
    ...
    map: [
      ...
      ["See your all-in fare before you book — online service fee, tolls and airport fees included; gratuity optional. No surge, no meter, no surprises.",
       "Mira tu tarifa total antes de reservar — tarifa de servicio en línea, peajes y cuotas de aeropuerto incluidos; propina opcional. Sin recargos, sin taxímetro, sin sorpresas."],
      ["All-inclusive pricing: the price you see is the total you pay (online service fee, tolls and airport fees included). Gratuity optional.", "Precio todo incluido: el precio que ves es el total que pagas (tarifa de servicio en línea, peajes y cuotas de aeropuerto incluidos). Propina opcional."],
      /* airports we serve */
  ...
  },
  {
    ...
    map: [
      ...
      ["Fixed hourly rate <span>· quoted before you book, all-inclusive, gratuity optional</span>",
       "Tarifa por hora fija <span>· cotizada antes de reservar, todo incluido, propina opcional</span>"],
