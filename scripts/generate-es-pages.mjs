...
const PAGES = [
  ...
  },
  {
    ...
    map: [
      /* head */
      ["Popular Luxury Routes & Fixed Fares | LAX Luxury Black SUV Service | RideYeah",
       "Rutas de Lujo Populares y Tarifas Fijas | Servicio SUV negra de lujo LAX | RideYeah"],
      ["Fixed-price luxury black SUV car service on LA & Orange County's top routes: LAX to Beverly Hills, Newport Beach, Anaheim, Disneyland, Santa Monica, Malibu & more.",
       "Servicio de auto SUV negra de lujo a precio fijo en las mejores rutas de LA y Orange County: LAX a Beverly Hills, Newport Beach, Anaheim, Disneyland, Santa Mónica, Malibú y más."],
      ...
      /* route cards */
      ["~30 min · Luxury Black SUV. Door-to-door to Beverly Hills hotels, residences and Rodeo Drive.",
       "~30 min · SUV negra de lujo. Puerta a puerta a hoteles, residencias y Rodeo Drive en Beverly Hills."],
      ["~50 min · Luxury Black SUV. To Newport Beach, Fashion Island, Balboa and the Orange County coast.",
       "~50 min · SUV negra de lujo. A Newport Beach, Fashion Island, Balboa y la costa de Orange County."],
      ["~40 min · Luxury Black SUV. Convention Center, hotels, Honda Center and the Disneyland Resort.",
       "~40 min · SUV negra de lujo. Convention Center, hoteles, Honda Center y el Disneyland Resort."],
      ["~40 min · Luxury Black SUV. Spacious for families and luggage; child seats on request.",
       "~40 min · SUV negra de lujo. Espaciosa para familias y equipaje; sillas para niños a pedido."],
      ["~25 min · Luxury Black SUV. To Santa Monica, Venice and the Westside beaches, door to door.",
       "~25 min · SUV negra de lujo. A Santa Mónica, Venice y las playas del Westside, puerta a puerta."],
      ["~50 min · Luxury Black SUV. A scenic coast run up to Malibu along the Pacific.",
       "~50 min · SUV negra de lujo. Un recorrido escénico por la costa del Pacífico hasta Malibú."],
      ["~35 min · Luxury Black SUV. To Pasadena, Old Town and the San Gabriel Valley.",
       "~35 min · SUV negra de lujo. A Pasadena, Old Town y el Valle de San Gabriel."],
      ["~45 min · Luxury Black SUV. Business travel to Irvine, the Spectrum and South Orange County.",
       "~45 min · SUV negra de lujo. Viajes de negocios a Irvine, el Spectrum y el sur de Orange County."],
  ...
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Beverly Hills Car Service | Private Luxury Black SUV | RideYeah",
       "Servicio de Auto LAX a Beverly Hills | SUV negra de lujo Privada | RideYeah"],
      ["Private LAX to Beverly Hills car service in a luxury black SUV. Flight tracking, meet-and-greet and a fixed fare from $95 — about 30 minutes, door to door.",
       "Servicio de auto privado de LAX a Beverly Hills en una SUV negra de lujo. Seguimiento de vuelos, recibimiento personal y una tarifa fija desde $95 — unos 30 minutos, puerta a puerta."],
      ...
      ["Private LAX → Beverly Hills luxury black SUV service. Flight tracking, meet-and-greet, fixed fare from $95.",
       "Servicio privado LAX → Beverly Hills en SUV negra de lujo. Seguimiento de vuelos, recibimiento, tarifa fija desde $95."],
      ...
      ["Private luxury car service from Los Angeles International (LAX) to Beverly Hills in a chauffeured luxury black SUV, with flight tracking, meet-and-greet and fixed pricing.",
       "Servicio de auto privado de lujo desde Los Ángeles Internacional (LAX) a Beverly Hills en una SUV negra de lujo con chofer, con seguimiento de vuelos, recibimiento personal y tarifas fijas."],
      ...
      ["Our fixed fare starts at $95 in a luxury black SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $95 en una SUV negra de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ["Do you offer meet-and-greet at LAX?", "¿Ofrecen recibimiento personal en LAX?"],
      ["Yes. Your chauffeur tracks your flight and meets you at the curb or in arrivals, helps with luggage and walks you to the luxury black SUV.",
       "Sí. Tu chofer sigue tu vuelo y te recibe en la acera o en llegadas, te ayuda con el equipaje y te acompaña a la SUV negra de lujo."],
      [">~30 min · from $95 · Luxury Black SUV</span>", ">~30 min · desde $95 · SUV negra de lujo</span>"],
      ['LAX to Beverly Hills,<br><span class="em">in quiet luxury.</span>',
       'LAX a Beverly Hills,<br><span class="em">en silencioso lujo.</span>'],
      ["Step off your flight and into a private luxury black SUV. Door-to-door from LAX to Beverly Hills hotels, residences and Rodeo Drive — flight tracked, fixed price, always on time.",
       "Baja del avión y sube a una SUV negra de lujo privada. Puerta a puerta desde LAX a hoteles, residencias y Rodeo Drive en Beverly Hills — vuelo monitoreado, precio fijo, siempre puntual."],
      ...
      ["Discreet, professional chauffeur &amp; <span>an immaculate luxury black SUV</span>",
       "Chofer profesional y discreto y <span>una SUV negra de lujo impecable</span>"],
  ...
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Disneyland Car Service | Private Luxury Black SUV | RideYeah",
       "Servicio de Auto LAX a Disneyland | SUV negra de lujo Privada | RideYeah"],
      ["Private LAX to Disneyland car service in a spacious luxury black SUV. Room for families and luggage, child seats on request, flight tracking and a fixed fare from $125.",
       "Servicio de auto privado de LAX a Disneyland en una espaciosa SUV negra de lujo. Espacio para familias y equipaje, sillas para niños a pedido, seguimiento de vuelos y una tarifa fija desde $125."],
      ...
      ["Spacious LAX → Disneyland luxury black SUV service for families. Child seats on request, luggage room, fixed fare from $125.",
       "Servicio LAX → Disneyland en SUV negra de lujo espaciosa para familias. Sillas para niños a pedido, espacio para equipaje, tarifa fija desde $125."],
      ...
      ["Private luxury car service from LAX to the Disneyland Resort in Anaheim, in a spacious chauffeured luxury black SUV with room for families and luggage, child seats on request and fixed pricing.",
       "Servicio de auto privado de lujo desde LAX al Disneyland Resort en Anaheim, en una espaciosa SUV negra de lujo con chofer, con espacio para familias y equipaje, sillas para niños a pedido y tarifas fijas."],
      ...
      ["Our fixed fare starts at $125 in a spacious luxury black SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $125 en una espaciosa SUV negra de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ["Do you provide child seats for the Disneyland trip?", "¿Ofrecen sillas para niños en el viaje a Disneyland?"],
      ["Yes. Add a note when you book and we will fit infant or booster seats. Our luxury black SUVs seat up to 7 with plenty of room for strollers and luggage.",
       "Sí. Añade una nota al reservar y colocamos sillas para bebés o booster. Nuestras SUV negra de lujo acomodan hasta 7 con espacio de sobra para coches de bebé y equipaje."],
      ["Yes. Add a note when you book and we'll fit infant or booster seats. Our luxury black SUVs seat up to 7 with plenty of room for strollers and luggage.",
       "Sí. Añade una nota al reservar y colocamos sillas para bebés o booster. Nuestras SUV negra de lujo acomodan hasta 7 con espacio de sobra para coches de bebé y equipaje."],
      [">~40 min · from $125 · Luxury Black SUV</span>", ">~40 min · desde $125 · SUV negra de lujo</span>"],
      ...
      ["Start the trip relaxed. A spacious luxury black SUV takes the whole family — and the luggage — from LAX straight to the Disneyland Resort and Anaheim hotels. Child seats on request, fixed price upfront.",
       "Empieza el viaje relajado. Una espaciosa SUV negra de lujo lleva a toda la familia — y el equipaje — desde LAX directo al Disneyland Resort y los hoteles de Anaheim. Sillas para niños a pedido, precio fijo por adelantado."],
      ...
      ["Spacious luxury black SUV, child seats on request, fixed price — door to door for the whole family.",
       "SUV negra de lujo espaciosa, sillas para niños a pedido, precio fijo — puerta a puerta para toda la familia."],
    ],
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Newport Beach Car Service | Private Luxury Black SUV | RideYeah",
       "Servicio de Auto LAX a Newport Beach | SUV negra de lujo Privada | RideYeah"],
      ["Private LAX to Newport Beach car service in a luxury black SUV. Flight tracking, meet-and-greet and a fixed fare from $135 — about 50 minutes to Orange County's coast.",
       "Servicio de auto privado de LAX a Newport Beach en una SUV negra de lujo. Seguimiento de vuelos, recibimiento personal y una tarifa fija desde $135 — unos 50 minutos a la costa de Orange County."],
      ...
      ["Private LAX → Newport Beach luxury black SUV service. Flight tracking, meet-and-greet, fixed fare from $135.",
       "Servicio privado LAX → Newport Beach en SUV negra de lujo. Seguimiento de vuelos, recibimiento, tarifa fija desde $135."],
      ...
      ["Private luxury car service from LAX to Newport Beach and Orange County's coast in a chauffeured luxury black SUV, with flight tracking, meet-and-greet and fixed pricing.",
       "Servicio de auto privado de lujo desde LAX a Newport Beach y la costa de Orange County en una SUV negra de lujo con chofer, con seguimiento de vuelos, recibimiento personal y tarifas fijas."],
      ...
      ["Our fixed fare starts at $135 in a luxury black SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $135 en una SUV negra de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ...
      [">~50 min · from $135 · Luxury Black SUV</span>", ">~50 min · desde $135 · SUV negra de lujo</span>"],
      ...
      ["Glide from the terminal to the Orange County coast in a private luxury black SUV — Newport Beach, Fashion Island, Balboa and beyond. Flight tracked, fixed price, door to door.",
       "Desliza desde la terminal hasta la costa de Orange County en una SUV negra de lujo privada — Newport Beach, Fashion Island, Balboa y más allá. Vuelo monitoreado, precio fijo, puerta a puerta."],
      ...
      ["Spacious luxury black SUV for <span>luggage, golf clubs &amp; gear</span>",
       "SUV negra de lujo espaciosa para <span>equipaje, palos de golf y equipo</span>"],
  ...
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Anaheim Car Service | Private Luxury Black SUV | RideYeah",
       "Servicio de Auto LAX a Anaheim | SUV negra de lujo Privada | RideYeah"],
      ["Private LAX to Anaheim car service in a luxury black SUV — Convention Center, hotels, Honda Center and Disneyland. Flight tracking and a fixed fare from $119.",
       "Servicio de auto privado de LAX a Anaheim en una SUV negra de lujo — Convention Center, hoteles, Honda Center y Disneyland. Seguimiento de vuelos y una tarifa fija desde $119."],
      ...
      ["Private LAX → Anaheim luxury black SUV service for the Convention Center, hotels and events. Fixed fare from $119.",
       "Servicio privado LAX → Anaheim en SUV negra de lujo para el Convention Center, hoteles y eventos. Tarifa fija desde $119."],
      ...
      ["Private luxury car service from LAX to Anaheim in a chauffeured luxury black SUV — for the Convention Center, hotels, Honda Center and the Disneyland Resort, with flight tracking and fixed pricing.",
       "Servicio de auto privado de lujo desde LAX a Anaheim en una SUV negra de lujo con chofer — para el Convention Center, hoteles, Honda Center y el Disneyland Resort, con seguimiento de vuelos y tarifas fijas."],
      ...
      ["Our fixed fare starts at $119 in a luxury black SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $119 en una SUV negra de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ...
      [">~40 min · from $119 · Luxury Black SUV</span>", ">~40 min · desde $119 · SUV negra de lujo</span>"],
      ['LAX to Anaheim,<br><span class="em">business or pleasure.</span>',
       'LAX a Anaheim,<br><span class="em">negocios o placer.</span>'],
      ["For the Convention Center, a conference hotel, a game at Honda Center or the Disneyland Resort — a private luxury black SUV from LAX, flight tracked and fixed price, door to door.",
       "Para el Convention Center, un hotel de conferencias, un partido en el Honda Center o el Disneyland Resort — una SUV negra de lujo privada desde LAX, vuelo monitoreado y precio fijo, puerta a puerta."],
