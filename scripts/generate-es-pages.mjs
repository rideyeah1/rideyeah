...
const SHARED = [
  ...
  ["· Luxury SUV</div>", "· SUV de lujo</div>"],
];
...
const ROUTE_COMMON = [
  ...
  ["Fixed price, flight tracking, professional chauffeur in a private luxury SUV.",
   "Precio fijo, seguimiento de vuelo y chofer profesional en una SUV de lujo privada."],
];
...
const PAGES = [
  {
    ...
    map: [
      ...
      ["Private LAX & SNA airport transfers with flight tracking, meet-and-greet and fixed pricing — in a premium luxury SUV fleet across Los Angeles & Orange County.",
       "Traslados privados a los aeropuertos LAX y SNA con seguimiento de vuelos, recibimiento personal y tarifas fijas — en una flota premium de SUV de lujo por Los Ángeles y Orange County."],
  ...
  },
  {
    ...
    map: [
      ...
      ["Premium black car service in Los Angeles & Orange County — executive luxury SUVs with professional chauffeurs, fixed pricing and total discretion.",
       "Servicio black car premium en Los Ángeles y Orange County — SUV de lujo ejecutivas con choferes profesionales, tarifas fijas y total discreción."],
      ...
      ["Executive black car service with professional chauffeurs and premium luxury SUVs across Los Angeles and Orange County, with fixed, transparent pricing.",
       "Servicio black car ejecutivo con choferes profesionales y SUV de lujo premium en Los Ángeles y Orange County, con tarifas fijas y transparentes."],
      /* breadcrumb + eyebrow */
      ...
      ["A professional chauffeur and an immaculate executive luxury SUV — for boardrooms, events, dinners and nights out. Discreet, punctual and priced upfront.",
       "Un chofer profesional y una impecable SUV de lujo ejecutiva — para reuniones, eventos, cenas y noches fuera. Discreto, puntual y con precio por adelantado."],
      ...
      ["Late-model luxury SUVs <span>· detailed before every ride</span>",
       "SUV de lujo de último modelo <span>· detalladas antes de cada viaje</span>"],
      ...
      ["Executive luxury SUV, professional chauffeur, fixed price. Reserve in under a minute.",
       "SUV de lujo ejecutiva, chofer profesional, precio fijo. Reserva en menos de un minuto."],
      [">Reserve your ride <svg", ">Reserva tu viaje <svg"],
    ],
  },
  {
    ...
    map: [
      /* head */
      ["Our Fleet · Luxury SUV Chauffeur Service | RideYeah",
       "Nuestra Flota · Servicio de Chofer en SUV de Lujo | RideYeah"],
      ["RideYeah operates a fleet of 20+ premium full-size luxury SUVs with spacious executive comfort, premium leather, onboard Wi-Fi and professional chauffeurs across Los Angeles & Orange County.",
       "RideYeah opera una flota de más de 20 SUV de lujo premium de tamaño completo con amplio confort ejecutivo, piel premium, Wi-Fi a bordo y choferes profesionales en Los Ángeles y Orange County."],
      ["luxury SUV chauffeur service Los Angeles, executive SUV service, Cadillac Escalade chauffeur, full-size luxury SUV service, private SUV service LAX",
       "servicio de chofer en SUV de lujo Los Ángeles, servicio SUV ejecutivo, chofer Cadillac Escalade, servicio SUV de lujo de tamaño completo, servicio SUV privado LAX"],
      ["Our Fleet · Luxury SUVs | RideYeah", "Nuestra Flota · SUV de Lujo | RideYeah"],
      ["A fleet of premium full-size luxury SUVs — one consistent, executive standard for every ride.",
       "Una flota de SUV de lujo premium de tamaño completo — un estándar ejecutivo y consistente en cada viaje."],
      /* JSON-LD */
      ['"serviceType": "Luxury SUV transportation"',
       '"serviceType": "Transporte en SUV de lujo"'],
      ['"name": "Luxury SUV Chauffeur Service"', '"name": "Servicio de Chofer en SUV de Lujo"'],
      ["A fleet of 20+ premium full-size luxury SUVs with professional chauffeurs, offering a consistent executive transportation experience across Los Angeles and Orange County.",
       "Una flota de más de 20 SUV de lujo premium de tamaño completo con choferes profesionales, que ofrece una experiencia de transporte ejecutivo consistente en Los Ángeles y Orange County."],
      /* breadcrumb + eyebrow */
      [" · Fleet</div>", " · Flota</div>"],
      [">Our fleet · Luxury SUVs</span>", ">Nuestra flota · SUV de lujo</span>"],
      /* hero */
      ['Luxury SUVs.<br><span class="em">Every ride.</span>',
       'SUV de lujo.<br><span class="em">En cada viaje.</span>'],
      ["We run a fleet of 20+ premium full-size luxury SUVs, held to one standard of space, comfort and discretion, every time, across Los Angeles &amp; Orange County.",
       "Operamos una flota de más de 20 SUV de lujo premium de tamaño completo con un mismo estándar de espacio, confort y discreción, siempre, en Los Ángeles y Orange County."],
      /* why RideYeah */
      [">Why RideYeah</span>", ">Por qué RideYeah</span>"],
      ...
      ["A managed fleet of 20+ luxury SUVs and professional chauffeurs means availability whenever you need it.",
       "Una flota gestionada de más de 20 SUV de lujo y choferes profesionales significa disponibilidad cuando la necesites."],
      /* inside every SUV */
      ...
      ["Reserve your luxury SUV.", "Reserva tu SUV de lujo."],
  ...
  },
  {
    ...
    map: [
      ...
      ["RideYeah is hiring professional, licensed chauffeurs to provide luxury ground transportation across Los Angeles and Orange County. Drivers operate our fleet of late-model luxury SUVs, providing airport transfers and private chauffeur service with discretion and punctuality.",
       "RideYeah busca choferes profesionales y con licencia para brindar transporte terrestre de lujo en Los Ángeles y Orange County. Los choferes operan nuestra flota de SUV de lujo de último modelo, ofreciendo traslados al aeropuerto y servicio de chofer privado con discreción y puntualidad."],
      /* breadcrumb + eyebrow */
  ...
  },
  {
    ...
    map: [
      ...
      ["Spacious luxury SUV <span>· seats up to 6 with luggage</span>",
       "Espaciosa SUV de lujo <span>· hasta 6 pasajeros con equipaje</span>"],
  ...
  },
  {
    ...
    map: [
      /* head */
      ["Popular Luxury Routes & Fixed Fares | LAX Luxury SUV Service | RideYeah",
       "Rutas de Lujo Populares y Tarifas Fijas | Servicio SUV de lujo LAX | RideYeah"],
      ["Fixed-price luxury SUV car service on LA & Orange County's top routes: LAX to Beverly Hills, Newport Beach, Anaheim, Disneyland, Santa Monica, Malibu & more.",
       "Servicio de auto SUV de lujo a precio fijo en las mejores rutas de LA y Orange County: LAX a Beverly Hills, Newport Beach, Anaheim, Disneyland, Santa Mónica, Malibú y más."],
      ...
      /* route cards */
      ["~30 min · Luxury SUV. Door-to-door to Beverly Hills hotels, residences and Rodeo Drive.",
       "~30 min · SUV de lujo. Puerta a puerta a hoteles, residencias y Rodeo Drive en Beverly Hills."],
      ["~50 min · Luxury SUV. To Newport Beach, Fashion Island, Balboa and the Orange County coast.",
       "~50 min · SUV de lujo. A Newport Beach, Fashion Island, Balboa y la costa de Orange County."],
      ["~40 min · Luxury SUV. Convention Center, hotels, Honda Center and the Disneyland Resort.",
       "~40 min · SUV de lujo. Convention Center, hoteles, Honda Center y el Disneyland Resort."],
      ["~40 min · Luxury SUV. Spacious for families and luggage; child seats on request.",
       "~40 min · SUV de lujo. Espaciosa para familias y equipaje; sillas para niños a pedido."],
      ["~25 min · Luxury SUV. To Santa Monica, Venice and the Westside beaches, door to door.",
       "~25 min · SUV de lujo. A Santa Mónica, Venice y las playas del Westside, puerta a puerta."],
      ["~50 min · Luxury SUV. A scenic coast run up to Malibu along the Pacific.",
       "~50 min · SUV de lujo. Un recorrido escénico por la costa del Pacífico hasta Malibú."],
      ["~35 min · Luxury SUV. To Pasadena, Old Town and the San Gabriel Valley.",
       "~35 min · SUV de lujo. A Pasadena, Old Town y el Valle de San Gabriel."],
      ["~45 min · Luxury SUV. Business travel to Irvine, the Spectrum and South Orange County.",
       "~45 min · SUV de lujo. Viajes de negocios a Irvine, el Spectrum y el sur de Orange County."],
  ...
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Beverly Hills Car Service | Private Luxury SUV | RideYeah",
       "Servicio de Auto LAX a Beverly Hills | SUV de lujo Privada | RideYeah"],
      ["Private LAX to Beverly Hills car service in a luxury SUV. Flight tracking, meet-and-greet and a fixed fare from $95 — about 30 minutes, door to door.",
       "Servicio de auto privado de LAX a Beverly Hills en una SUV de lujo. Seguimiento de vuelos, recibimiento personal y una tarifa fija desde $95 — unos 30 minutos, puerta a puerta."],
      ...
      ["Private LAX → Beverly Hills luxury SUV service. Flight tracking, meet-and-greet, fixed fare from $95.",
       "Servicio privado LAX → Beverly Hills en SUV de lujo. Seguimiento de vuelos, recibimiento, tarifa fija desde $95."],
      ...
      ["Private luxury car service from Los Angeles International (LAX) to Beverly Hills in a chauffeured luxury SUV, with flight tracking, meet-and-greet and fixed pricing.",
       "Servicio de auto privado de lujo desde Los Ángeles Internacional (LAX) a Beverly Hills en una SUV de lujo con chofer, con seguimiento de vuelos, recibimiento personal y tarifas fijas."],
      ...
      ["Our fixed fare starts at $95 in a luxury SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $95 en una SUV de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ["Do you offer meet-and-greet at LAX?", "¿Ofrecen recibimiento personal en LAX?"],
      ["Yes. Your chauffeur tracks your flight and meets you at the curb or in arrivals, helps with luggage and walks you to the luxury SUV.",
       "Sí. Tu chofer sigue tu vuelo y te recibe en la acera o en llegadas, te ayuda con el equipaje y te acompaña a la SUV de lujo."],
      [">~30 min · from $95 · Luxury SUV</span>", ">~30 min · desde $95 · SUV de lujo</span>"],
      ['LAX to Beverly Hills,<br><span class="em">in quiet luxury.</span>',
       'LAX a Beverly Hills,<br><span class="em">en silencioso lujo.</span>'],
      ["Step off your flight and into a private luxury SUV. Door-to-door from LAX to Beverly Hills hotels, residences and Rodeo Drive — flight tracked, fixed price, always on time.",
       "Baja del avión y sube a una SUV de lujo privada. Puerta a puerta desde LAX a hoteles, residencias y Rodeo Drive en Beverly Hills — vuelo monitoreado, precio fijo, siempre puntual."],
      ...
      ["Discreet, professional chauffeur &amp; <span>an immaculate luxury SUV</span>",
       "Chofer profesional y discreto y <span>una SUV de lujo impecable</span>"],
  ...
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Disneyland Car Service | Private Luxury SUV | RideYeah",
       "Servicio de Auto LAX a Disneyland | SUV de lujo Privada | RideYeah"],
      ["Private LAX to Disneyland car service in a spacious luxury SUV. Room for families and luggage, child seats on request, flight tracking and a fixed fare from $125.",
       "Servicio de auto privado de LAX a Disneyland en una espaciosa SUV de lujo. Espacio para familias y equipaje, sillas para niños a pedido, seguimiento de vuelos y una tarifa fija desde $125."],
      ...
      ["Spacious LAX → Disneyland luxury SUV service for families. Child seats on request, luggage room, fixed fare from $125.",
       "Servicio LAX → Disneyland en SUV de lujo espaciosa para familias. Sillas para niños a pedido, espacio para equipaje, tarifa fija desde $125."],
      ...
      ["Private luxury car service from LAX to the Disneyland Resort in Anaheim, in a spacious chauffeured luxury SUV with room for families and luggage, child seats on request and fixed pricing.",
       "Servicio de auto privado de lujo desde LAX al Disneyland Resort en Anaheim, en una espaciosa SUV de lujo con chofer, con espacio para familias y equipaje, sillas para niños a pedido y tarifas fijas."],
      ...
      ["Our fixed fare starts at $125 in a spacious luxury SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $125 en una espaciosa SUV de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ["Do you provide child seats for the Disneyland trip?", "¿Ofrecen sillas para niños en el viaje a Disneyland?"],
      ["Yes. Add a note when you book and we will fit infant or booster seats. Our luxury SUVs seat up to 7 with plenty of room for strollers and luggage.",
       "Sí. Añade una nota al reservar y colocamos sillas para bebés o booster. Nuestras SUV de lujo acomodan hasta 7 con espacio de sobra para coches de bebé y equipaje."],
      ["Yes. Add a note when you book and we'll fit infant or booster seats. Our luxury SUVs seat up to 7 with plenty of room for strollers and luggage.",
       "Sí. Añade una nota al reservar y colocamos sillas para bebés o booster. Nuestras SUV de lujo acomodan hasta 7 con espacio de sobra para coches de bebé y equipaje."],
      [">~40 min · from $125 · Luxury SUV</span>", ">~40 min · desde $125 · SUV de lujo</span>"],
      ...
      ["Start the trip relaxed. A spacious luxury SUV takes the whole family — and the luggage — from LAX straight to the Disneyland Resort and Anaheim hotels. Child seats on request, fixed price upfront.",
       "Empieza el viaje relajado. Una espaciosa SUV de lujo lleva a toda la familia — y el equipaje — desde LAX directo al Disneyland Resort y los hoteles de Anaheim. Sillas para niños a pedido, precio fijo por adelantado."],
      ...
      ["Spacious luxury SUV, child seats on request, fixed price — door to door for the whole family.",
       "SUV de lujo espaciosa, sillas para niños a pedido, precio fijo — puerta a puerta para toda la familia."],
    ],
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Newport Beach Car Service | Private Luxury SUV | RideYeah",
       "Servicio de Auto LAX a Newport Beach | SUV de lujo Privada | RideYeah"],
      ["Private LAX to Newport Beach car service in a luxury SUV. Flight tracking, meet-and-greet and a fixed fare from $135 — about 50 minutes to Orange County's coast.",
       "Servicio de auto privado de LAX a Newport Beach en una SUV de lujo. Seguimiento de vuelos, recibimiento personal y una tarifa fija desde $135 — unos 50 minutos a la costa de Orange County."],
      ...
      ["Private LAX → Newport Beach luxury SUV service. Flight tracking, meet-and-greet, fixed fare from $135.",
       "Servicio privado LAX → Newport Beach en SUV de lujo. Seguimiento de vuelos, recibimiento, tarifa fija desde $135."],
      ...
      ["Private luxury car service from LAX to Newport Beach and Orange County's coast in a chauffeured luxury SUV, with flight tracking, meet-and-greet and fixed pricing.",
       "Servicio de auto privado de lujo desde LAX a Newport Beach y la costa de Orange County en una SUV de lujo con chofer, con seguimiento de vuelos, recibimiento personal y tarifas fijas."],
      ...
      ["Our fixed fare starts at $135 in a luxury SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $135 en una SUV de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ...
      [">~50 min · from $135 · Luxury SUV</span>", ">~50 min · desde $135 · SUV de lujo</span>"],
      ...
      ["Glide from the terminal to the Orange County coast in a private luxury SUV — Newport Beach, Fashion Island, Balboa and beyond. Flight tracked, fixed price, door to door.",
       "Desliza desde la terminal hasta la costa de Orange County en una SUV de lujo privada — Newport Beach, Fashion Island, Balboa y más allá. Vuelo monitoreado, precio fijo, puerta a puerta."],
      ...
      ["Spacious luxury SUV for <span>luggage, golf clubs &amp; gear</span>",
       "SUV de lujo espaciosa para <span>equipaje, palos de golf y equipo</span>"],
  ...
  },
  {
    ...
    map: [
      ...ROUTE_COMMON,
      ["LAX to Anaheim Car Service | Private Luxury SUV | RideYeah",
       "Servicio de Auto LAX a Anaheim | SUV de lujo Privada | RideYeah"],
      ["Private LAX to Anaheim car service in a luxury SUV — Convention Center, hotels, Honda Center and Disneyland. Flight tracking and a fixed fare from $119.",
       "Servicio de auto privado de LAX a Anaheim en una SUV de lujo — Convention Center, hoteles, Honda Center y Disneyland. Seguimiento de vuelos y una tarifa fija desde $119."],
      ...
      ["Private LAX → Anaheim luxury SUV service for the Convention Center, hotels and events. Fixed fare from $119.",
       "Servicio privado LAX → Anaheim en SUV de lujo para el Convention Center, hoteles y eventos. Tarifa fija desde $119."],
      ...
      ["Private luxury car service from LAX to Anaheim in a chauffeured luxury SUV — for the Convention Center, hotels, Honda Center and the Disneyland Resort, with flight tracking and fixed pricing.",
       "Servicio de auto privado de lujo desde LAX a Anaheim en una SUV de lujo con chofer — para el Convention Center, hoteles, Honda Center y el Disneyland Resort, con seguimiento de vuelos y tarifas fijas."],
      ...
      ["Our fixed fare starts at $119 in a luxury SUV — all-in, with tolls and gratuity included and no surge pricing.",
       "Nuestra tarifa fija comienza en $119 en una SUV de lujo — todo incluido, con peajes y propina, sin recargos por demanda."],
      ...
      [">~40 min · from $119 · Luxury SUV</span>", ">~40 min · desde $119 · SUV de lujo</span>"],
      ['LAX to Anaheim,<br><span class="em">business or pleasure.</span>',
       'LAX a Anaheim,<br><span class="em">negocios o placer.</span>'],
      ["For the Convention Center, a conference hotel, a game at Honda Center or the Disneyland Resort — a private luxury SUV from LAX, flight tracked and fixed price, door to door.",
       "Para el Convention Center, un hotel de conferencias, un partido en el Honda Center o el Disneyland Resort — una SUV de lujo privada desde LAX, vuelo monitoreado y precio fijo, puerta a puerta."],
