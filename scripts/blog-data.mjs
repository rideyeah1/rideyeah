...
const AUTHORED = [
  // ───────────────────────── 1 · Thousand Oaks ─────────────────────────
  {
    ...
    metaDescription:
      "The calm, reliable way to get from LAX to Thousand Oaks: a private luxury black SUV with flight tracking, meet-and-greet and a fixed $226.87 fare. Compare your options.",
    ...
    faq: [
      {
        ...
        a: "RideYeah's fixed fare for LAX ⇄ Thousand Oaks starts at $226.87 in a luxury black SUV — all-inclusive, with the online service fee, tolls and airport fees included, gratuity optional, and no surge pricing. Fares may change without notice; use the booking search for an exact, instant quote.",
      },
      {
  ...
  // ───────────────────────── 2 · Calabasas ─────────────────────────
  {
    ...
    metaDescription:
      "Private, discreet LAX to Calabasas transportation in a luxury black SUV. Flight tracking, meet-and-greet and a fixed $185.67 fare — door to door in about 40 minutes.",
    ...
    faq: [
      {
        ...
        a: "RideYeah's fixed fare for LAX ⇄ Calabasas starts at $185.67 in a luxury black SUV — all-inclusive, with the online service fee, tolls and airport fees included, gratuity optional, and no surge pricing. Fares may change without notice; use the booking search for an exact, instant quote.",
      },
      {
...
export const QUEUE = [
  ...
  },
  {
    ...
    hero: "band_highway",
    brief:
      "Family-focused guide to a private LAX → Anaheim/Disneyland transfer: car seats by request, space for luggage and strollers, fixed $185.67 fare, ~40 min drive, no surge after a long flight. Funnel to /lax-to-anaheim.",
  },
  {
